...
*/
    ...
    trianglesv[0]  = Triangle(v2, v3, v4, defaultMaterial);
    trianglesv[1]  = Triangle(v8, v7, v6, defaultMaterial);
    trianglesv[2]  = Triangle(v5, v6, v2, defaultMaterial);
    trianglesv[3]  = Triangle(v6, v7, v3, defaultMaterial);
    trianglesv[4]  = Triangle(v3, v7, v8, defaultMaterial);
    trianglesv[5]  = Triangle(v1, v4, v8, defaultMaterial);
    trianglesv[6]  = Triangle(v1, v2, v4, defaultMaterial);
    trianglesv[7]  = Triangle(v5, v8, v6, defaultMaterial);
    trianglesv[8]  = Triangle(v1, v5, v2, defaultMaterial);
    trianglesv[9]  = Triangle(v2, v6, v3, defaultMaterial);
    trianglesv[10] = Triangle(v4, v3, v8, defaultMaterial);
    trianglesv[11] = Triangle(v5, v1, v8, defaultMaterial);
